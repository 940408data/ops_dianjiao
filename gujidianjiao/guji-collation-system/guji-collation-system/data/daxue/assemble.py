...
CORPUS = pathlib.Path("/root/ops_dianjiao/大学章句")
OUT = pathlib.Path(__root__ := "/root/ops_dianjiao/gujidianjiao/guji-collation-system/guji-collation-system/data/daxue")
